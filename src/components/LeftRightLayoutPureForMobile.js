...
class LeftRightLayoutPureForMobile extends React.Component {

  componentDidMount() {
    window.echo('mobile left right layout');
    api.checkToken().catch(handleErrorForMobile);
  }
  ...
  render () {
    ...
    return (
      <Layout style={{}}>
        <HandleErrorForMobile pathname={encodeURIComponent(this.props.location.pathname + this.props.location.search)} />
...
export default connect(mapStateToProps)(LeftRightLayoutPureForMobile)
