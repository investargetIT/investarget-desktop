  ...
  render() {
    ...
    return (
      <Form>
        ...
        <BasicFormItem label={i18n("user.institution")} name="org" required={!this.props.isTraderAddInvestor} valueType="number">
            <SelectExistOrganization allowCreate={false} formName="userform" size="large" />
        </BasicFormItem>
