...
const headerStyle = {height: 80, margin: '0 auto', backgroundColor: '#fff'}
const logoStyle = {height: 70, padding: '10px 0'}
const bodyStyle = {margin: '0 auto', position: 'relative', 
  display: 'flex',
  justifyContent: 'center',
  alignItems: 'center',
};
const footerStyle = {margin: '0 auto', marginTop: 152, marginBottom: 60}
const copyrightStyle = {textAlign:'center',lineHeight:'20px',fontSize:12,color:'#989898', marginBottom: 0}

class LoginContainerForMobile extends React.Component {
...
export default LoginContainerForMobile
