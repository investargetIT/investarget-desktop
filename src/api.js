...
export const editGovernmentProject = (id, body) => r(`/proj/govproj/${id}/`, 'PUT', body);
...
export const getGovernmentProjectTraders = params => r(`/proj/govproj/trader/?${qs.stringify(params)}`);
