...
export default {
  ...
  effects: {
    ...
    *changePage({ payload : page }, { call, put, select }) {
      const { pageSize } = yield select(state => state.emailDetail)
