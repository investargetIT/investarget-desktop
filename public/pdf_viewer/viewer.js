...
// 根据url参数设置语言
if (/locale=en/.test(document.location.search.substring(1))) {
  _pdfjsLib.PDFJS.locale = 'en-US';
}
{
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'pdf_viewer/pdf.worker.min.js';
  PDFJS.cMapUrl = 'pdf_viewer/cmaps/';
  ...
  open: function open(file, args) {
    ...
    return loadingTask.promise.then(function (pdfDocument) {
      ...
      return loadingErrorMessage.then(function (msg) {
        // dispatch error
        PDFViewerApplication.eventBus.dispatch('loaderror', {message: msg});
...
var validateFileURL;
{
  var HOSTED_VIEWER_ORIGINS = ['null', 'https://www.investarget.com'];
